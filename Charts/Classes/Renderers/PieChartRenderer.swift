...
//            let formatter = dataSet.valueFormatter
            // for show byte value in labels
            let formatter = dataSet.byteFormatter
...
//                let val = formatter!.stringFromNumber(value)!
                let text = formatter!.stringFromByteCount(Int64(value))
                ...
                {
                    ChartUtils.drawText(context: context, text: text, point: CGPoint(x: x, y: y), align: .Center, attributes: [NSFontAttributeName: valueFont, NSForegroundColorAttributeName: valueTextColor])
                ...
                {
                    ChartUtils.drawText(context: context, text: text, point: CGPoint(x: x, y: y + lineHeight / 2.0), align: .Center, attributes: [NSFontAttributeName: valueFont, NSForegroundColorAttributeName: valueTextColor])
                }
