...
public class ChartData: NSObject
{
    ...
    // Sets a custom ByteFormatter for all DataSets this data object contains
    public func setByteFormatter(formatter: NSByteCountFormatter) {
        for set in dataSets {
            set.byteFormatter = formatter 
        }
    }
