...
public class ChartDataSet: NSObject
{
    ...
    // for binary formatter I added it in 31.01.16
    internal var _byteFormatter: NSByteCountFormatter? = ChartUtils.defaultByteFormatter()
    ...
    public var byteFormatter: NSByteCountFormatter?
        ...
        set
        {
            if newValue == nil
            {
                _byteFormatter = ChartUtils.defaultByteFormatter()
            }
            else
            {
                _byteFormatter = newValue
            }
        }
    }
