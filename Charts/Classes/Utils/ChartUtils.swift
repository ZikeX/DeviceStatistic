...
public class ChartUtils
{
    ...
    // Alexsander add it
    private static var _defaultByteFormatter: NSByteCountFormatter = ChartUtils.generateDefaultByteFormatter()
    ...
    // 31.01.16
    private class func generateDefaultByteFormatter() -> NSByteCountFormatter
    {
    ...
    internal class func defaultByteFormatter() -> NSByteCountFormatter
    {
        return _defaultByteFormatter
    }
